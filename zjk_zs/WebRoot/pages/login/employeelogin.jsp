...
<body>
	<div class="xyh-login">
		<div class="xyh-login-form">	
			<form action="login-employeelogin.jmy" method="post" id="login">
			<div class="title">可追溯商品质量服务平台（员工）</div>
			<table width="70%" align="center" border="0">
				...
				<tr>
					<th width="29%" align="right">企业码:</th>
					<td width="71%">
						<input type="encode" value="${encode }" name="encode" class="len220"/>
					</td>
				</tr>
				<tr>
