    ...
    <form action="" method="post" id="form_do" name="form_do">
       ...
       <div class="page" style="clear: both;">
		   <div>
			   ...
			   <a class="prev" href="circulate-sell.php?enterpriseid=${enterpriseid }&pageNow=${pageNow-1 }"><<</a>
			   <c:choose>
			   <c:when test="${pageNow<3 }">
			   		<c:forEach begin="1" end="${pageCount>5?5:pageCount }" var="page">
			   			...
			   			<c:if test="${page!=pageNow }">
							<a class="num"  href="circulate-sell.php?enterpriseid=${enterpriseid }&pageNow=${page }">${page }</a>		   			
				   		</c:if>
			   		</c:forEach>
			   </c:when>
			   ...
			   <a class="next" href="circulate-sell.php?enterpriseid=${enterpriseid }&pageNow=${pageNow+1 }">>></a>
		   </div>
	   </div>
