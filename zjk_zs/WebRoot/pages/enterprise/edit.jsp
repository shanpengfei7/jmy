...
<script type="text/javascript" src="js/calendar.config.js"></script>
  ...
  <body>
   ...
   <!--  <div class="pos">当前位置 | 企业管理 &gt 企业添加</div> -->
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="enterprise-edit.php">
		...
		<div class="form_b">		
			<input type="reset" class="btn_green" id="" value="重置"> <input type="button" onclick="pswd()" class="btn_blue" value="密码修改"><input type="submit" class="btn_blue" id="" value="提 交"> 
			${error } 
		</div>
	   </form>
	</div>
...
<script type="text/javascript">
	...
	function pswd() {
		window.location.href="pages/enterprise/pswd.jsp";
	}
</script>
  </body>
</html>
