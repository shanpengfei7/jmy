    ...
    <form action="" method="post" id="form_do" name="form_do">
        <table width="100%">
			...
			<c:forEach items="${waybills }" var="w" varStatus="s">
				<tr>
	                ...
	                <td>
	                	<a href="waybill-dlist.php?waybillid=${w.id }">查看物品</a>
	                	<a href="waybill-show.php?waybillid=${w.id }">详情</a>
       ...
       <div class="page" style="clear: both;">
		   <div>
			   ...
			   <a class="prev" href="waybill-delist.php?pageNow=${pageNow-1 }"><<</a>
			   <c:choose>
			   <c:when test="${pageNow<3 }">
			   		<c:forEach begin="1" end="${pageCount>5?5:pageCount }" var="page">
			   			...
			   			<c:if test="${page!=pageNow }">
							<a class="num"  href="waybill-delist.php?pageNow=${page }">${page }</a>		   			
				   		</c:if>
			   		</c:forEach>
			   </c:when>
			   ...
			   <a class="next" href="waybill-delist.php?pageNow=${pageNow+1 }">>></a>
		   </div>
	   </div>
