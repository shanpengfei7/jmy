...
<script type="text/javascript" src="js/calendar.config.js"></script>
  ...
  <body>
    <div class="main">
    <!-- <div class="pos">当前位置 | 物流信息  &gt 发货信息</div> -->
    <div class="operate">
        <div class="left">
            ...
            <dd>
                ...
                <script type="text/javascript">
                    Calendar.setup({
                        ...
                        onSelect   : function() {
                        	this.hide();
                        	window.location.href="appinfo-delist.php?employeeid="+$("#employeeid").val()+"&packagetime=" + $("#publishtime").val();	
                        }
                    });
                </script>
            </dd>
    ...
    <form action="" method="post" id="form_do" name="form_do">
        <table width="100%">
			...
			<c:forEach items="${waybills }" var="w" varStatus="s">
				<tr>
	                ...
	                <td>${w.deliveremployee.name }</td>
	                <td><date:date value="${w.delivertime }"></date:date></td>
	                <td>${w.willreceiveenterprise.company }</td>
	                <td>
	                	<a href="appinfo-dlist.php?waybillid=${w.id }">查看物品</a>
       ...
       <%-- <div class="page" style="clear: both;">
		   <div>
			   ...
			   <a class="prev" href="appinfo-delist.php?pageNow=${pageNow-1 }"><<</a>
			   <c:choose>
			   <c:when test="${pageNow<3 }">
			   		<c:forEach begin="1" end="${pageCount>5?5:pageCount }" var="page">
			   			...
			   			<c:if test="${page!=pageNow }">
							<a class="num"  href="appinfo-delist.php?pageNow=${page }">${page }</a>		   			
				   		</c:if>
			   		</c:forEach>
			   </c:when>
			   ...
			   <a class="next" href="appinfo-delist.php?pageNow=${pageNow+1 }">>></a>
		   </div>
	   </div> --%>
