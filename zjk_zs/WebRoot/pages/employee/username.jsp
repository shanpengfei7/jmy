...
<script type="text/javascript" src="js/calendar.config.js"></script>
  ...
  <body>
	...
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="employee-username.php">
		...
		<dl>
			...
			<dd>
				<c:if test="${!empty param.name }">
					<input type="text" name="password" class="inp_large" value="${param.name }" readonly="readonly" />
				</c:if>
				<c:if test="${empty param.name }">
					<input type="text" name="name" class="inp_large" value="${password }" readonly="readonly" />
				</c:if>
			</dd>
		</dl>
		<dl>
