				...
				<tr>
	                ...
	                <td>
	                	<c:if test="${empty sessionScope.adminId }">
		                	<a href="qrcode-iadd.php?pid=${p.id }&operate=2">生成二维码</a>
		                </c:if>
		                <%-- <a href="qrcode-qrlist.php?enterpriseid=${enterpriseid }&pid=${p.id }">列出二维码</a> --%>
		                <a href="qrcode-dlist.php?enterpriseid=${enterpriseid }&pid=${p.id }">下载二维码</a>
		               <%--  <a href="qrcode-evalist.php?enterpriseid=${enterpriseid }&pid=${p.id }">列出评价信息</a> --%>
					</td>
            </tr>
			</c:forEach>
        </table>
