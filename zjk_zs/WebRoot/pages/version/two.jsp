...
<html>
  <head>
    ...
    <title>My JSP 'employee-list.jsp' starting page</title>
...
<script type="text/javascript">
	function btn_return() {
		window.location.href="version-applying.php";
	}
	function select_this(id) {
		window.location.href="version-three.php?id=" + id;
	}
</script>
  </head>
  ...
  <body>
    ...
    <div class="operate">
        <div class="left">
                <input type="button" onclick="btn_return()" class="btn_blue" value="返回">请选择二级分类
        </div>
        <div class="left_pad">
    ...
    <form action="" method="post" id="form_do" name="form_do">
        <table width="100%">
			...
			<c:forEach items="${coiCategoryTwos }" var="c">
				<tr>
	                <td>${c.id }</td>
	                <td>${c.fullCode }</td>
	                <td>${c.name }</td>
