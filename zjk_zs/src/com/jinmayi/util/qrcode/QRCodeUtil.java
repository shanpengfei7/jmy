package com.jinmayi.util.qrcode;
...
public class QRCodeUtil {
	...
	public static void main(String[] args) throws Exception {
		String text = "http://192.168.108.201:8080/zs/show.php?token=COI186shanpengfei72904000322cdc-X000000";
		QRCodeUtil.encode(text, "c:/image.jpg", "c:", "ok.jpg", true);

		// String text = "http://www.dans88.com.cn";
		// QRCodeUtil.encode(text, "d:/MyWorkDoc/my180.jpg", "d:/MyWorkDoc",
		// true);
	}
