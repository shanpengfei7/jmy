...
@Controller
@Scope("prototype")
public class VersionpAction extends ActionSupport {
	...
	public String check() throws Exception {
		...
		nextUrl = "versionp-adminapplying.php";
		return NONE;
	}
	...
	public String applying() throws Exception {
		products = versionService.getProductsApplyingp(getEid());
		return SUCCESS;
	}

	public String adminapplying() throws Exception {
		products = versionService.getProductsApplyingp();
	...
	public String edit() throws Exception {
		...
		if (ad == 1) {
			nextUrl = "versionp-adminapplied.php";
		} else if (ad == 2) {
			nextUrl = "versionp-applying.php";
		}
		return NONE;
	...
	public String adminapplied() throws Exception {
		products = versionService.getProductsAppliedp();
		for (Product p : products) {
			enterprise = enterpriseService.getEnterpriseById(p.getEnterpriseid());
			p.setEnterprise(enterprise);
		}
	...
	public String padd() throws Exception {
		...
		// nextUrl = "versionp-applied.php";
		nextUrl = "versionp-plist.php?pid=" + pid;
		return NONE;
	}
