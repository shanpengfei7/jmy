...
<body>
	<div class="login">
		<div class="loginForm">	
			<form action="user/login.jmy" method="post" id="login">
			<div class="title">
			接口服务平台 			</div>
			<table width="100%">
				<tr>
				...
				<tr>
					<td  style="padding-left:120px;"> 
						<input type="button" onclick="sub();" class="btn_blue" value="登录"/></td>
						
						<td style="padding-left:120px;"> <input type="button" onclick="register_btn()" class="btn_blue" value="注册"/>
					<span  class="error">${error }</span><span  class="msg"></span></td>
				</tr>
			</table>
		</form>
		</div>
...
<script type="text/javascript" src="common/js/jquery-2.1.4.min.js"></script>
  <script type="text/javascript">
	function sub() {
		$.post("user/login.jmy", $('form').serialize(), function (data) {
			if(data==1) {
				location.href="user/info.jmy?o=c";
			} else {
				alert(data);
			}
		});
