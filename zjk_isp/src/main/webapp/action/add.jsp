<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
 <%@ include file="../admin/nav.jsp" %>
  <title>接口分类添加</title>
  ${error }
    <form class="layui-form" action="action/add.jmy" method="post">
    <input type="hidden" value="${param.cid }" id="cid" name="cid">
...
<script type="text/javascript" src="common/js/jquery-2.1.4.min.js"></script>
  <script type="text/javascript">
	function sub() {
		$.post("action/add.jmy", $('form').serialize(), function (data) {alert(data);location.href="action/list.jmy?cid="+$("#cid").val();});
	}
 </script>
