...
<html>
 ...
 <style type="text/css">
  ...
  <div class="all__content">
            ...
            <form action="jcxx?m=sss" method="post" enctype="multipart/form-data" id="jcxx-all">
                <input type="hidden" value="${token }" name="token">
                <label for="ri_qi" >首诊日期：</label>
                <input type="datetime-local " name="ri_qi" id="ri_qi" value="${shou_zhen_ri_qi }" readonly="readonly" />
                <label for="men_zhen_hao" class="text_2"> 门诊号：</label>
                <input type="text" name="men_zhen_hao" id="men_zhen_hao" value="" />
                <label for="bing_an_hao" class="text_2">病案号：</label>
                <input type="text" name="bing_an_hao" id="bing_an_hao"value=""/>
                 <br/>
                <br/>
                <label for="zhu_guan_yi_shi"> 主管医师：</label>
                <select name="zhu_guan_yi_shi" id="zhu_guan_yi_shi" class="text_4">
                ...
                <select name="suo_shu_ke_shi" id="suo_shu_ke_shi" class="text_4">
                	<option>请选择</option>
                ...
                <select name="zhuan_ke_yi_sheng" id="zhuan_ke_yi_sheng" class="text_4">
                ...
                <input type="text" name="xing_ming" id="xing_ming" class="text_1">
                ...
                <input type="number" min="0" max="150" name="nian_ling" id="nian_ling"/> -->
                <label for="nian" class="text_2">出生日期：</label>
                <!-- <input type="number" min="0" max="150" name="nian_ling" id="nian_ling" readonly="readonly" /> -->
                <input type="number" min="0" max="3000" name="nian" id="nian" style="width: 50px;" class="text_6"/>年
                <input type="number" min="1" max="12" name="yue" id="yue" style="width: 50px;" />月
                <input type="number" min="1" max="31" name="ri" id="ri" style="width: 50px;" />日
                <br/>
                <br/>
                <label for="min_zu">民族：</label>
                <input type="text" name="min_zu" id="min_zu" value="汉" class="text_1"/>
                ...
                <input type="number" step="0.001" min="0" max="350" id="shen_gao" name="shen_gao"/><span>cm</span>
                <label for="ti_zhong" class="text_2">体重：</label>
                <input type="number" step="0.001" min="0" max="350" name="ti_zhong" id="ti_zhong" /><span>kg</span>
                 <br/>
                <br/>
                <label for="chu_sheng_di">出生地：</label>
                <input type="text" name="chu_sheng_di" id="chu_sheng_di" class="jianju2">
                 <br/>
                <br/>
                ...
                <label for="wen_hua_cheng_du" class="text_2">文化程度：</label>
                ...
                <label for="jia_li_pai_hang_1" class="text_2">家里排行：</label>
                <input type="number" min="1" max="31" name="jia_li_pai_hang_1" id="jia_li_pai_hang_1" style="width: 50px;" value="1" />
                /
                <input type="number" min="1" max="31" name="jia_li_pai_hang_2" id="jia_li_pai_hang_2" style="width: 50px;" value="1" />
                <br/><br/>
                <label for="liang_hao">经济状况：</label>
                      <input type="radio" name="jing_ji_zhuang_kuang" id="liang_hao" value="良好" class="text_6"/><label for="liang_hao">良好</label>
                      <input type="radio" name="jing_ji_zhuang_kuang" id="yi_ban" value="一般" class="jianju6"/><label for="yi_ban">一般</label>
                      <input type="radio" name="jing_ji_zhuang_kuang" id="jiao_cha" value="较差" class="jianju6"/><label for="jiao_cha">较差</label>
                      <input type="radio" name="jing_ji_zhuang_kuang" id="hen_cha" value="很差" class="jianju6"/><label for="hen_cha">很差</label>
                      <label for="lian_xi_dian_hua" class="text_2">联系电话：</label>
                      <input type="text" name="lian_xi_dian_hua" id="lian_xi_dian_hua" class="text_1"/>
                 <br/>
                <br/>
                ...
                <label for="ji_bing_wen_ti">就诊原因：</label>
                      <input type="checkbox" name="jiu_zhen_yuan_yin" value="疾病问题" id="ji_bing_wen_ti" class="text_6"/><label for="ji_bing_wen_ti" class="jianju8">疾病问题</label>
                ...
                <input type="checkbox" name="shuimian" value="良好" id="shui_mian_liang_hao" /><label for="shui_mian_liang_hao" class="jianju8">良好</label>
                <input type="checkbox" name="shuimian" value="一般" id="shui_mian_yi_ban"/><label for="shui_mian_yi_ban" class="jianju8">一般</label>
                <input type="checkbox" name="shuimian" value="欠佳" id="shui_mian_qian_jia"/><label for="shui_mian_qian_jia" class="jianju8">欠佳</label>
                ...
                <input type="checkbox" name="shuimian" value="多梦" id="duo_meng"/><label for="duo_meng">多梦</label>
                 <br/>
                <br/>
                ...
                <label for="xing_sheng_huo_liang_hao" class="text_3"> 性生活：</label>
                <input type="radio" name="xingshenghuo" value="良好" id="xing_sheng_huo_liang_hao" class="text_6"/><label for="xing_sheng_huo_liang_hao" class="text_6"> 良好</label>
                ...
                <input type="checkbox" name="chu_xian_1" value="情绪低落" id="qing_xu_di_luo" class="text_6"/><label for="qing_xu_di_luo" class="jianju8"> 情绪低落</label>
                <input type="checkbox" name="chu_xian_1" value="烦燥易怒" id="fan_zao_yi_nu"/><label for="fan_zao_yi_nu" class="jianju8"> 烦燥易怒</label>
                <input type="checkbox" name="chu_xian_1" value="兴奋躁动" id="xing_fun_zao_daog"/><label for="xing_fun_zao_daog" class="jianju8"> 兴奋躁动</label>
                <input type="checkbox" name="chu_xian_1" value="神经衰弱" id="shen_jing_shuai_ruo"/><label for="shen_jing_shuai_ruo" class="jianju8"> 神经衰弱</label>
                <input type="checkbox" name="chu_xian_1" value="情感淡漠" id="qing_gan_dan_mo"/><label for="qing_gan_dan_mo" class="jianju8"> 情感淡漠</label>
                <input type="checkbox" name="chu_xian_1" value="消极悲观" id="xiao_ji_bei_guan"/><label for="xiao_ji_bei_guan" class="jianju8"> 消极悲观</label>
                <input type="checkbox" name="chu_xian_1" value="兴趣下降" id="xing_qu_xia_jiang"/><label for="xing_qu_xia_jiang" class="jianju8"> 兴趣下降</label>
                 <br/>
                <br/>
                <label for="zhu_yi_fen_san"> 是否出现：</label>
                <input type="checkbox" name="chu_xian2" value="注意分散" id="zhu_yi_fen_san" class="text_6"/><label for="zhu_yi_fen_san" class="jianju8"> 注意分散</label>
                <input type="checkbox" name="chu_xian2" value="记忆障碍" id="ji_yi_zhang_ai"/><label for="ji_yi_zhang_ai" class="jianju8"> 记忆障碍</label>
                <input type="checkbox" name="chu_xian2" value="错觉" id="cuo_jue"/><label for="cuo_jue" class="jianju8"> 错觉</label>
                <input type="checkbox" name="chu_xian2" value="幻觉" id="huan_jue"/><label for="huan_jue" class="jianju8"> 幻觉</label>
                <input type="checkbox" name="chu_xian2" value="妄想" id="wang_xiang"/><label for="wang_xiang" class="jianju8"> 妄想</label>
                <input type="checkbox" name="chu_xian2" value="意识障碍" id="yi_shi_zhang_ai"/><label for="yi_shi_zhang_ai" class="jianju8"> 意识障碍</label>
                <input type="checkbox" name="chu_xian2" value="行为障碍" id="xing_wei_zhang_ai"/><label for="xing_wei_zhang_ai" class="jianju8"> 行为障碍</label>
                <input type="checkbox" name="chu_xian2" value="行为退缩" id="xing_wei_tui_suo"/><label for="xing_wei_tui_suo" class="jianju8"> 行为退缩</label>
                <input type="checkbox" name="chu_xian2" value="生活懒散" id="sheng_huo_lan_san"/><label for="sheng_huo_lan_san" class="jianju8"> 生活懒散</label>
                <input type="checkbox" name="chu_xian2" value="意志力下降" id="yi_zhi_li_xia_jiang"/><label for="yi_zhi_li_xia_jiang" class="jianju8"> 意志力下降</label>
                 <br/>
                <br/>
                <label>现<span class="jianju2"></span>病<span class="jianju2"></span>史：</label><label for="xian_has_lei_si_fa_zuo_wu">1.有否类似发作: </label>
                ...
                <input type="radio" id="xian_has_lei_si_fa_zuo_wu" name="xian_has_lei_si_fa_zuo" value="无"><label for="xian_has_lei_si_fa_zuo_wu">无</label>
                <label for="xian_has_qu_ti_ji_bing_wu" class="text_2">2.有否躯体疾病 :</label>
                ...
                <input type="radio" id="xian_has_qu_ti_ji_bing_you" name="xian_has_qu_ti_ji_bing" value="偶发"><label for="xian_has_qu_ti_ji_bing_you">有</label>          
                 <br/>
                <br/>
                <label for="xian_bing_shi"> 具体疾病的诊断，时间 和用药史:</label>
                <br/>
                <textarea id="xian_bing_shi" name="xian_bing_shi" style="width: 1050px;">
                </textarea>
                 <br/>
                <br/>
                <label>既往病史：</label><label for="ji_wang_has_lei_si_fa_zuo_wu">1.有否类似发作: </label>
                ...
                <label for="ji_wang_has_qu_ti_ji_bing_wu" class="text_2">2.有否躯体疾病 :</label>
                ...
                <input type="radio" id="ji_wang_has_qu_ti_ji_bing_you" name="ji_wang_has_qu_ti_ji_bing" value="偶发"><label for="ji_wang_has_qu_ti_ji_bing_you">有</label>          
                 <br/>
                <br/>
                <label for="ji_wang_bing_shi"> 就诊医院，具体疾病的诊断及治疗，时间 和用药史:</label>
                <br/>
                <textarea id="ji_wang_bing_shi" name="ji_wang_bing_shi" style="width: 1050px;">
                </textarea>
                 <br/>
                <br/>
                <label>家族病史：</label><label for="jia_zu_has_ji_bing_wu">父系母系三代以内有否精神疾病、癫痫或心理疾病: </label>
                ...
                <input type="radio" id="jia_zu_has_ji_bing_you" name="jia_zu_has_ji_bing" value="偶发"><label for="ji_wang_has_ji_bing_you">有</label>          
                 <br/>
                <br/>
                <label for="jia_zu_bing_shi"> 具体疾病的诊断，时间 和用药史:</label>
                <br/>
                <textarea id="jia_zu_bing_shi" name="jia_zu_bing_shi" style="width: 1050px;">
                </textarea>
                 <br/>
                <br/>
                ...
                <label for="wen_ding" class="text_3">情绪稳定性：</label>
                ...
                <label for="xue_xing_a_xing" class="text_3"> 血型：</label>
                ...
                <input type="text" id="qita" name="yan_jiu_qi_ta" class="jianju">
                 <br/>
                <br/>
                <label for="zu_yue"> 生长发育：</label>
                <input type="checkbox" name="shengzhang" value="足月" id="zu_yue" class="text_6"/><label for="zu_yue" > 足月</label>
                ...
                <input type="checkbox" name="fuyangren" value="祖父/母" id="zu_fu_mu" class="text_6"/><label for="zu_fu_mu" > 祖父/母</label>
               ...
               <label for="jiyangshi1" class="text_2"> 其他寄养史（几岁到几岁）</label>
                ...
                <label for="you_nian_huan_jing_he_xie"> 幼年生活环境：</label>
                 <input type="checkbox" name="you_nian_huan_jing" value="和谐" id="you_nian_huan_jing_he_xie" class="text_6"/><label for="you_nian_huan_jing_he_xie" > 和谐</label>
                 ...
                 <input type="checkbox" name="you_nian_huan_jing" value="冷淡" id="you_nian_huan_jing_leng_dan"/><label for="you_nian_huan_jing_leng_dan" >冷淡</label>
                ...
                <br/>
                 ...
                 <input type="checkbox" name="xian_zai_huan_jing" value="和谐" id="xian_zai_huan_jing_he_xie" class="text_6"/><label for="xian_zai_huan_jing_he_xie" > 和谐</label>
                 ...
                 <input type="checkbox" name="xian_zai_huan_jing" value="民主" id="xian_zai_huan_jing_min_zhu"/><label for="xian_zai_huan_jing_min_zhu" >民主</label>
                ...
                <label for="yu_xiong_di_jie_mei_liang_hao"> 与兄弟姐妹们关系：</label>
                 <input type="radio" name="yu_xiong_di_jie_mei_guan_xi" value="良好" id="yu_xiong_di_jie_mei_liang_hao"class="text_6"/><label for="yu_xiong_di_jie_mei_liang_hao"> 良好</label>
                ...
                <label for="fu_qi_guan_xi_liang_hao"> 夫妻关系：</label>
                 <input type="radio" name="fu_qi_guan_xi" value="良好" id="fu_qi_guan_xi_liang_hao" class="text_6"/><label for="fu_qi_guan_xi_liang_hao"> 良好</label>
                ...
                <label for="po_xi_guan_xi_liang_hao">婆媳关系：</label>
                 <input type="radio" name="po_xi_guan_xi" value="良好" id="po_xi_guan_xi_liang_hao" class="text_6"/><label for="po_xi_guan_xi_liang_hao"> 良好</label>
                ...
                <input type="checkbox" name="wenti" value="封闭" id="wen_ti_biao_xian_feng_bi"/><label for="wen_ti_biao_xian_feng_bi" class="jianju8">封闭</label>
                <input type="checkbox" name="wenti" value="误会" id="wen_ti_biao_xian_wu_hui"/><label for="wen_ti_biao_xian_wu_hui" > 误会</label>
                <input type="checkbox" name="wenti" value="不会相处" id="wen_ti_biao_xian_bu_hui_xiang_chu"/><label for="wen_ti_biao_xian_bu_hui_xiang_chu" class="jianju8">不会相处</label>
                 <br/>
                <br/>
				...
				<br/><br/>
                <label for="else"> 其他：</label><input type="text" name="qitafangmian" id="else" class="jianju"/>
                 <br/>
                <br/>
                ...
                <input type="checkbox" name="bu_man_yi_fang_mian" value="经济" id="bu_man_yi_jing_ji"/><label for="bu_man_yi_jing_ji" class="jianju8">经济</label>
                ...
                <input type="radio" name="ji_bing_ren_zhi" value="完全错误" id="dang_qian_ji_bing_wan_quan_cuo_wu"/><label for="dang_qian_ji_bing_wan_quan_cuo_wu"> 完全错误</label>
                 <br/>
                <br/>
                <label for="ji_bing_yu_hou_tai_du_fei_chang_le_guan"> 疾病愈后的态度：</label>
               ...
               <br/>
               <br/>
               <label for="yin_xiang_shuai_ruo"> 印象：</label>
               ...
               <br/><br/>
               <label for="yin_xiang_qi_ta">其它</label><input type="text" id="yin_xiang_qi_ta" name="yin_xiang_qi_ta" class="jianju"/>
                <br/>
                <br/>
				<!-- <label for="chu_zhi_xin_shen">处置:</label>
...
$(document).ready(function(){
	...
	$("#jcxx-all").submit(function(){
		...
		if($("#nan").attr("checked") == undefined && $("#nv").attr("checked") == undefined) {
			alert("性别未填！！");
			return false;
		}
		if($.trim($("#nian").val()) == "") {
