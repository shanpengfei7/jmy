  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong"><textarea name="jianYi" rows="" cols="" style="width: 690px;height: 530px;">${c.jianYi }</textarea>  </div>
                </div>
                <div>
                    <div class="bg_biao_ti">膳食</div>
                    <div class="bg_nei_rong"><textarea name="yaoShan" rows="" cols="" style="width: 690px;height: 700px;">${c.yaoShan }</textarea> </div>
                </div>
                <input type="submit" value="保存">
                </form>
            </div>
        <div style="margin: 10px 200px;"><a href="xzbr?m=ibg&id=${j.id }"><input type="button" value="返回考试或查看报告"></a></div>
        </div>
