  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">
                        <table width="700" border="1" cellspacing="0">
                            <tr>
                                <td colspan="2" align="center">抑郁症筛查量表</td>
                ...
                <div>
                    ...
                    <div class="bg_nei_rong"><textarea name="yiJian" style="width: 690px;height: 100px;">${c.yiJian }</textarea></div>
                    <div class="bg_biao_ti">建议</div>
                    <div class="bg_nei_rong"><textarea name="jianYi" rows="" cols="" style="width: 690px;height: 100px;">${c.jianYi }</textarea></div>
                </div>
