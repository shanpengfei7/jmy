  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong"><textarea name="belongE" rows="" cols="" style="width: 690px;height: 100px;">${c.belongE }</textarea></div>
                    <div class="bg_nei_rong"><textarea name="yiJianE" rows="" cols="" style="width: 690px;height: 200px;">${c.yiJianE }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongN" rows="" cols="" style="width: 690px;height: 100px;">${c.belongN }</textarea></div>
                    <div class="bg_nei_rong"><textarea name="yiJianN" rows="" cols="" style="width: 690px;height: 200px;">${c.yiJianN }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongP" rows="" cols="" style="width: 690px;height: 100px;">${c.belongP }</textarea></div>
                    <div class="bg_nei_rong"><textarea name="yiJianP" rows="" cols="" style="width: 690px;height: 200px;">${c.yiJianP }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongL" rows="" cols="" style="width: 690px;height: 100px;">${c.belongL }</textarea></div>
                    <div class="bg_nei_rong"><textarea name="yiJianL" rows="" cols="" style="width: 690px;height: 200px;">${c.yiJianL }</textarea></div><br>
                </div>
