  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">主要症状：${c.belong1 }</div>
                    <div class="bg_nei_rong">次要症状：${c.belong2 }</div><br>
                    <div class="bg_nei_rong">${c.yiJian1 }</div>
                    <div class="bg_nei_rong">${c.yiJian2 }</div>
                </div>
            </div><div style="margin: 10px 200px;">
            <a href="xzbr?m=ibg&id=${j.id }"><input type="button" value="返回考试或查看报告"></a>
            <a href="bggl?m=iebg&id=${j.id }&c=${c.ciShu }&l=4"><input type="button" value="修改报告"></a>
            </div>
        </div>
