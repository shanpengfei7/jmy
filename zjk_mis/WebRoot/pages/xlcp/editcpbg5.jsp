  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong"><textarea name="belongQuTiHua" rows="" cols="" style="width: 690px;height: 100px;">${c.belongQuTiHua }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongQiangPoZheng" rows="" cols="" style="width: 690px;height: 100px;">${c.belongQiangPoZheng }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongRenJiGuanXi" rows="" cols="" style="width: 690px;height: 100px;">${c.belongRenJiGuanXi }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongYiYu" rows="" cols="" style="width: 690px;height: 100px;">${c.belongYiYu }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongJiaoLv" rows="" cols="" style="width: 690px;height: 100px;">${c.belongJiaoLv }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongDiDui" rows="" cols="" style="width: 690px;height: 100px;">${c.belongDiDui }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongKongBu" rows="" cols="" style="width: 690px;height: 100px;">${c.belongKongBu }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongPianZhi" rows="" cols="" style="width: 690px;height: 100px;">${c.belongPianZhi }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongJingShenBing" rows="" cols="" style="width: 690px;height: 100px;">${c.belongJingShenBing }</textarea></div><br>
                    <div class="bg_nei_rong"><textarea name="belongQiTa" rows="" cols="" style="width: 690px;height: 100px;">${c.belongQiTa }</textarea></div><br>
                </div>
