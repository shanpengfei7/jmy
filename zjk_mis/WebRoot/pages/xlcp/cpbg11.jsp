...
<html>
  ...
  <div class="all__content">
            <div class="bg__con">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">
                        <table width="700" border="1" cellspacing="0">
                            <tr>
                                <td colspan="2" align="center">阴性症状量表</td>
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">
                        ...
                        <table width="700" border="1" cellspacing="0">
                            ...
                            <tr>
                                <td>情感平淡或迟钝</td>
                                <td id="qing_gan">${c.qingGanPingDan }</td>
                            </tr>
                            <tr>
                                <td>思维贫乏</td>
                                <td id="si_wei">${c.siWeiPinFa }</td>
                            </tr>
                            <tr>
                                <td>意志缺乏</td>
                                <td id="yi_zhi">${c.yiZhiQueFa }</td>
                            </tr>
                            <tr>
                                <td>注意障碍</td>
                                <td id="zhu_yi">${c.zhuYiZhangAi }</td>
                            </tr>
                            <tr>
                                <td>兴趣社交</td>
                                <td id="xing_qu">${c.xingQuSheJiao }</td>
                            </tr>
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">${c.show }</div>
                </div>
            </div><div style="margin: 10px 200px;">
            <a href="xzbr?m=ibg&id=${j.id }"><input type="button" value="返回考试或查看报告"></a>
            <a href="bggl?m=iebg&id=${j.id }&c=${c.ciShu }&l=11"><input type="button" value="修改报告"></a>
            </div>
        </div>
 ...
 <script type="text/javascript">
    ...
    xAxis : [
        {
            type : 'category',
            data : ['情感平淡或迟钝', '思维贫乏', '意志缺乏', '注意障碍', '兴趣社交'],
            axisTick: {
                alignWithLabel: true
            }
        }
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[$("#qing_gan").text(),$("#si_wei").text(),$("#yi_zhi").text(),$("#zhu_yi").text(),$("#xing_qu").text()]
        }
    ]
};
m.setOption(option);
