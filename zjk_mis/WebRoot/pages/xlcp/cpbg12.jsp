...
<html>
  ...
  <div class="all__content">
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">
                        <table width="700" border="1" cellspacing="0">
                            <tr>
                                <td colspan="2" align="center">阳性症状量表</td>
                ...
                <div>
                    ...
                    <div class="bg_nei_rong">
                        ...
                        <table width="700" border="1" cellspacing="0">
                            ...
                            <tr>
                                <td>怪异行为</td>
                                <td id="guai_yi">${c.guaiYiXingWei }</td>
                            </tr>
                            <tr>
                                <td>幻觉</td>
                                <td id="huan_jue">${c.huanJue }</td>
                            </tr>
                            <tr>
                                <td>妄想</td>
                                <td id="wang_xiang">${c.wangXiang }</td>
                            </tr>
                            <tr>
                                <td>阳性思维形式障碍</td>
                                <td id="yang_xing">${c.yangXingSiWei }</td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <a href="bggl?m=iebg&id=${j.id }&c=${c.ciShu }&l=12"><input type="button" value="修改报告"></a>
            </div>
        </div>
    ...
    series : [
        {
            ...
            type:'bar',
            barWidth: '60%',
            data:[$("#guai_yi").text(),$("#huan_jue").text(),$("#wang_xiang").text(),$("#yang_xing").text()]
        }
    ]
};
m.setOption(option);
