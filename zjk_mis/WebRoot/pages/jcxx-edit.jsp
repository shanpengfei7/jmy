...
<html>
 ...
 <style type="text/css">
  ...
  <div class="all__content">
            ...
            <form action="jcxx?m=ccc" method="post" id="jcxx-all" enctype="multipart/form-data">
            	<input type="hidden" name="jcxxId" id="jcxxId" value="${j.id }"  />
            	<label for="yong_hu_id">用户ID：</label>
                <input type="text" name="yong_hu_id" id="yong_hu_id" value="${j.yongHuId }" readonly="readonly" />
                <label for="ri_qi" class="text_2">首诊日期：</label>
                ...
                <input type="text" name="xing_ming" id="xing_ming" value="${j.xingMing }">
                ...
                <input type="number" step="0.001" min="0" max="350" id="shen_gao" name="shen_gao" value="${j.shenGao }" /><span>cm</span>
                <label for="ti_zhong" class="text_2">体重：</label>
                <input type="number" step="0.001" min="0" max="350" name="ti_zhong" id="ti_zhong" value="${j.tiZhong }"/><span>kg</span>
                <br /><br />
                ...
                <select name="zhi_ye" id="zhi_ye">
                    <option value="${j.zhiYe }">${j.zhiYe }</option>
                ...
                <select name="wen_hua_cheng_du" id="wen_hua_cheng_du">
                    <option value="${j.wenHuaChengDu }">${j.wenHuaChengDu }</option>
                ...
                <label for="lian_xi_dian_hua" class="text_2">联系电话：</label><input value="${j.lianXiDianHua }" type="text" name="lian_xi_dian_hua" id="lian_xi_dian_hua"/>   
                <br/><br/>
                <label for="lian_xi_di_zhi">联系地址：</label>
                <input value="${j.lianXiDiZhi }" type="text" name="lian_xi_di_zhi" id="lian_xi_di_zhi" class="jianju"/>
                <br/><br/><hr><br>
                ...
                <br/><br/>
                <label for="shui_mian_liang_hao"> 睡眠：</label>
                ...
                <br/><br/>
                <label>现病史：</label><label for="xian_has_lei_si_fa_zuo_wu">1.有否类似发作: </label>
                ...
                <input type="radio" id="xian_has_lei_si_fa_zuo_wuy" name="xian_has_lei_si_fa_zuo" value="无"><label for="xian_has_lei_si_fa_zuo_wuy">无</label>
                </c:if>
                ...
                <c:if test="${j.xianLeiSiFaZuo==4 }">
                <input type="radio" id="xian_has_lei_si_fa_zuo_wu" name="xian_has_lei_si_fa_zuo" value="反复发作"><label for="xian_has_lei_si_fa_zuo_wu">反复发作</label>
                <input type="radio" id="xian_has_lei_si_fa_zuo_ou_fa" name="xian_has_lei_si_fa_zuo" value="间断发作"><label for="xian_has_lei_si_fa_zuo_ou_fa">间断发作</label>
                <input type="radio" id="xian_has_lei_si_fa_zuo_duo_fa" name="xian_has_lei_si_fa_zuo" value="偶发"><label for="xian_has_lei_si_fa_zuo_duo_fa">偶发</label>
				<input type="radio" id="xian_has_lei_si_fa_zuo_wuy"  checked="checked" name="xian_has_lei_si_fa_zuo" value="无"><label for="xian_has_lei_si_fa_zuo_wuy">无</label>
                </c:if>
                ...
                <br/><br/>
                <label for="xian_bing_shi"> 具体疾病的诊断，时间 和用药史:</label> <br/>
                ...
                <label>家族病史：</label><label for="jia_zu_has_ji_bing_wu">父系母系三代以内有否精神疾病、癫痫或心理疾病: </label>
	                <c:if test="${j.jiaZuBingShi==1 }">
		      			<input type="radio" id="jia_zu_has_ji_bing_wu" checked="checked" name="jia_zu_has_ji_bing" value="无"><label for="jia_zu_has_ji_bing_wu">无</label>
		                <input type="radio" id="jia_zu_has_ji_bing_you" name="jia_zu_has_ji_bing" value="偶发"><label for="jia_zu_has_ji_bing_you">有</label>          
	                </c:if>
                <c:if test="${j.jiaZuBingShi==2 }">
      			<input type="radio" id="jia_zu_has_ji_bing_wu" name="jia_zu_has_ji_bing" value="无"><label for="jia_zu_has_ji_bing_wu">无</label>
                <input type="radio" id="jia_zu_has_ji_bing_you" checked="checked" name="jia_zu_has_ji_bing" value="偶发"><label for="jia_zu_has_ji_bing_you">有</label>          
                </c:if>
                ...
                <br/><br/>
                <label for="yan"> 烟</label><input type="number" value="${j.yan }" min="0" max="250" name="ya" id="yan" class="sheng_zhang_fa_yu" />支/天，
                <label for="jiu"> 酒</label><input type="number" min="0" value="${j.jiu }" max="250" name="jiu" id="jiu"  class="sheng_zhang_fa_yu" />两/天，
                <label for="qita"> 其他</label>
                <input type="text" value="${j.yanJiuQiTa }" id="qita" name="yan_jiu_qi_ta" class="jianju">
                <br/><br/>
                ...
                <label for="huizou" class="text_2"> 学步</label><input type="number" value="${j.xueBu }" min="1" max="250" name="walk" id="huizou" class="sheng_zhang_fa_yu" />岁，
               ...
               <label for="jiyangshi1"> 其他寄养史（几岁到几岁）</label>
                ...
                <br><br>
                 ...
                 <c:if test="${j.qinZiGuanXi==1 }">
	                 <input type="radio" name="qin_zi_guan_xi" checked="checked" value="良好" id="qin_zi_guan_xi_liang_hao" class="text_6"/><label for="qin_zi_guan_xi_liang_hao"> 良好</label>
                 ...
                 <c:if test="${j.qinZiGuanXi==2 }">
	                ...
	                <input type="radio" name="qin_zi_guan_xi" checked="checked" value="尚可" id="qin_zi_guan_xi_shang_ke"/><label for="qin_zi_guan_xi_shang_ke">尚可</label>
	                <input type="radio" name="qin_zi_guan_xi" value="一般" id="qin_zi_guan_xi_yi_ban"/><label for="qin_zi_guan_xi_yi_ban"> 一般</label>
	                <input type="radio" name="qin_zi_guan_xi" value="冷淡" id="qin_zi_guan_xi_leng_dan"/><label for="qin_zi_guan_xi_leng_dan"> 冷淡</label>
	                <input type="radio" name="qin_zi_guan_xi" value="差" id="qin_zi_guan_xi_cha"/><label for="qin_zi_guan_xi_cha"> 差</label>
                  </c:if>
                 <c:if test="${j.qinZiGuanXi==3 }">
	                 <input type="radio" name="qin_zi_guan_xi" value="良好" id="qin_zi_guan_xi_liang_hao" class="text_6"/><label for="qin_zi_guan_xi_liang_hao"> 良好</label>
	                <input type="radio" name="qin_zi_guan_xi" value="尚可" id="qin_zi_guan_xi_shang_ke"/><label for="qin_zi_guan_xi_shang_ke">尚可</label>
	                <input type="radio" name="qin_zi_guan_xi" checked="checked" value="一般" id="qin_zi_guan_xi_yi_ban"/><label for="qin_zi_guan_xi_yi_ban"> 一般</label>
	                <input type="radio" name="qin_zi_guan_xi" value="冷淡" id="qin_zi_guan_xi_leng_dan"/><label for="qin_zi_guan_xi_leng_dan"> 冷淡</label>
	                <input type="radio" name="qin_zi_guan_xi" value="差" id="qin_zi_guan_xi_cha"/><label for="qin_zi_guan_xi_cha"> 差</label>
                  </c:if>
                 <c:if test="${j.qinZiGuanXi==4 }">
	                 <input type="radio" name="qin_zi_guan_xi" value="良好" id="qin_zi_guan_xi_liang_hao" class="text_6"/><label for="qin_zi_guan_xi_liang_hao"> 良好</label>
	                <input type="radio" name="qin_zi_guan_xi" value="尚可" id="qin_zi_guan_xi_shang_ke"/><label for="qin_zi_guan_xi_shang_ke">尚可</label>
	                <input type="radio" name="qin_zi_guan_xi" value="一般" id="qin_zi_guan_xi_yi_ban"/><label for="qin_zi_guan_xi_yi_ban"> 一般</label>
	                <input type="radio" name="qin_zi_guan_xi" checked="checked" value="冷淡" id="qin_zi_guan_xi_leng_dan"/><label for="qin_zi_guan_xi_leng_dan"> 冷淡</label>
	                <input type="radio" name="qin_zi_guan_xi" value="差" id="qin_zi_guan_xi_cha"/><label for="qin_zi_guan_xi_cha"> 差</label>
                  </c:if>
                 <c:if test="${j.qinZiGuanXi==5 }">
	                 <input type="radio" name="qin_zi_guan_xi" value="良好" id="qin_zi_guan_xi_liang_hao" class="text_6"/><label for="qin_zi_guan_xi_liang_hao"> 良好</label>
	                <input type="radio" name="qin_zi_guan_xi" value="尚可" id="qin_zi_guan_xi_shang_ke"/><label for="qin_zi_guan_xi_shang_ke">尚可</label>
	                <input type="radio" name="qin_zi_guan_xi" value="一般" id="qin_zi_guan_xi_yi_ban"/><label for="qin_zi_guan_xi_yi_ban"> 一般</label>
	                <input type="radio" name="qin_zi_guan_xi" value="冷淡" id="qin_zi_guan_xi_leng_dan"/><label for="qin_zi_guan_xi_leng_dan"> 冷淡</label>
	                <input type="radio" name="qin_zi_guan_xi" checked="checked" value="差" id="qin_zi_guan_xi_cha"/><label for="qin_zi_guan_xi_cha"> 差</label>
                  </c:if>
                 <c:if test="${j.qinZiGuanXi==null }">
	                 <input type="radio" name="qin_zi_guan_xi" value="良好" id="qin_zi_guan_xi_liang_hao" class="text_6"/><label for="qin_zi_guan_xi_liang_hao"> 良好</label>
	                <input type="radio" name="qin_zi_guan_xi" value="尚可" id="qin_zi_guan_xi_shang_ke"/><label for="qin_zi_guan_xi_shang_ke">尚可</label>
	                <input type="radio" name="qin_zi_guan_xi" value="一般" id="qin_zi_guan_xi_yi_ban"/><label for="qin_zi_guan_xi_yi_ban"> 一般</label>
	                <input type="radio" name="qin_zi_guan_xi" value="冷淡" id="qin_zi_guan_xi_leng_dan"/><label for="qin_zi_guan_xi_leng_dan"> 冷淡</label>
                ...
                <select name="fu_qin_zhi_ye">
                    <option value="${j.fuQinZhiYe }">${j.fuQinZhiYe }</option>
                    <option value="农牧业">农牧业</option>
                    <option value="渔业">渔业</option>
                    <option value="木材、森林业">木材、森林业</option>
                    <option value="矿业、采石业">矿业、采石业</option>
                ...
                <select name="mu_qin_zhi_ye">
                    <option value="${j.muQinZhiYe }">${j.muQinZhiYe }</option>
                    <option value="农牧业">农牧业</option>
                    <option value="渔业">渔业</option>
                    <option value="木材、森林业">木材、森林业</option>
                    <option value="矿业、采石业">矿业、采石业</option>
                ...
                <select name="fu_qin_wen_hua">
                    <option value="${j.fuQinWenHuaChengDu }">${j.fuQinWenHuaChengDu }</option>
                    <option value="文盲">文盲</option>
                    <option value="小学">小学</option>
                    <option value="初中">初中</option>
                    <option value="高中">高中</option>
                ...
                <select name="mu_qin_wen_hua">
                    <option value="${j.muQinWenHuaChengDu }">${j.muQinWenHuaChengDu }</option>
                    <option value="文盲">文盲</option>
                    <option value="小学">小学</option>
                    <option value="初中">初中</option>
                    <option value="高中">高中</option>
                ...
                <input type="text" value="${j.wenTiFaShengQiTa }" name="qitafangmian" id="else" class="jianju"/>
                <br/><br/>
                ...
                <br/><br/>
			    <label> 家谱图：</label>
			    <input type="button" id="jia_pu_tu_btn" value="选择家谱图">
			    <input type="hidden" id="jia_pu_tu_hou" name="jia_pu_tu" />
			    <span id="jia_pu_tu_qian"></span>
			   <img id="jpt_pic" src="img/imgs/${j.jiaPuTu }" onclick="big_small('jpt_pic')" width="65px" height="65px">
			   
			   <label class="text_2">备注：</label>
			   <input type="text" name="jia_pu_tu_bei_zhu" value="${j.jiaPuTuBeiZhu }" class="jianju">
			   <br/><br/>
			   <label>房树人：</label><input type="file" name="fang_shu_ren" value="上传房树人" id="fang_shu_ren" style="width: 150px"/>
               <img id="fsr_pic" src="img/upload/${j.fangShuRen }" onclick="big_small('fsr_pic')"  width="65px" height="65px">
                <br/><br/>
               ...
               <input type="radio" name="yin_xiang" id="yin_xiang_wang_xiang" value="妄想状态"><label for="yin_xiang_wang_xiang">妄想状态</label>
				...
				<br/><br/>
               <label>其它</label>
               <input type="text" name="yin_xiang_qi_ta" value="${j.yinXiangQiTa }" class="jianju"/>
               <br><br>
...
function bigger(id){
	...
	/* document.getElementById(id).style.margin='-100px 0 0 0'; */
}
function smaller(id){
