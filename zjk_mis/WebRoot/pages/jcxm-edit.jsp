  ...
  <div class="all__content">
            <div style="margin-left: 20px">
               ...
               <input type="number" min="0" max="250" name="jia_li_pai_hang_2" id="jia_li_pai_hang_2" value="${j.paiHang2 }" readonly="readonly" />
                ...
                <label for="lian_xi_dian_hua" class="text_1">联系电话：</label><input type="text" name="lian_xi_dian_hua" value="${j.lianXiDianHua }" id="lian_xi_dian_hua" readonly="readonly" />
                <br/><br/>
		        ...
		        <br><br>
<form action="jcxm?m=cjcxm" method="post">
        		...
        		<input type="hidden" name="jian_ce_xiang_mu_id" id="jian_ce_xiang_mu_id" value="${jc.id }">
				</div>
