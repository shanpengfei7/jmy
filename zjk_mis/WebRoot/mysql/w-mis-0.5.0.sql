...
CREATE TABLE `can_kao` (
  ...
  CONSTRAINT `can_kao_ibfk_1` FOREIGN KEY (`liang_biao_id`) REFERENCES `liang_biao` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ce_ping_bao_gao1` (
  ...
  CONSTRAINT `ce_ping_bao_gao1_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `ce_ping_bao_gao10` (
  ...
  CONSTRAINT `ce_ping_bao_gao10_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao11` (
  ...
  CONSTRAINT `ce_ping_bao_gao11_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao12` (
  ...
  CONSTRAINT `ce_ping_bao_gao12_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao13` (
  ...
  CONSTRAINT `ce_ping_bao_gao13_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao2` (
  ...
  CONSTRAINT `ce_ping_bao_gao2_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao3` (
  ...
  CONSTRAINT `ce_ping_bao_gao3_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao4` (
  ...
  CONSTRAINT `ce_ping_bao_gao4_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao5` (
  ...
  CONSTRAINT `ce_ping_bao_gao5_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao6` (
  ...
  CONSTRAINT `ce_ping_bao_gao6_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao7` (
  ...
  CONSTRAINT `ce_ping_bao_gao7_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao8` (
  ...
  CONSTRAINT `ce_ping_bao_gao8_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ce_ping_bao_gao9` (
  ...
  CONSTRAINT `ce_ping_bao_gao9_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `da_an` (
  ...
  CONSTRAINT `da_an_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `da_an_ibfk_2` FOREIGN KEY (`liang_biao_id`) REFERENCES `liang_biao` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `jian_ce_xiang_mu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `isdelete` tinyint(1) NOT NULL DEFAULT '0',
  `cuShu` int(11) NOT NULL,
  `riQi` datetime NOT NULL,
  `jianCeXiangMu` varchar(255) DEFAULT NULL,
  `ji_chu_xin_xi_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ji_chu_xin_xi_id` (`ji_chu_xin_xi_id`),
  CONSTRAINT `jian_ce_xiang_mu_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ji_chu_xin_xi` (
  ...
  CONSTRAINT `ji_chu_xin_xi_ibfk_1` FOREIGN KEY (`ke_shi_id`) REFERENCES `ke_shi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ji_chu_xin_xi_ibfk_2` FOREIGN KEY (`zhuan_ke_yisheng_id`) REFERENCES `yi_sheng` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ji_chu_xin_xi_ibfk_3` FOREIGN KEY (`yi_yuan_id`) REFERENCES `yi_yuan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `shi_ti` (
  ...
  CONSTRAINT `shi_ti_ibfk_1` FOREIGN KEY (`liang_biao_id`) REFERENCES `liang_biao` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- ----------------------------
-- Table structure for `xin_li_ce_ping`
-- ----------------------------
DROP TABLE IF EXISTS `xin_li_ce_ping`;
CREATE TABLE `xin_li_ce_ping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `isdelete` tinyint(1) NOT NULL DEFAULT '0',
  `isCePing` tinyint(1) NOT NULL DEFAULT '0',
  `xinLiCePing` varchar(255) DEFAULT NULL,
  `jian_ce_xiang_mu_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `jian_ce_xiang_mu_id` (`jian_ce_xiang_mu_id`),
  CONSTRAINT `xin_li_ce_ping_ibfk_1` FOREIGN KEY (`jian_ce_xiang_mu_id`) REFERENCES `jian_ce_xiang_mu` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of xin_li_ce_ping
-- ----------------------------
...
CREATE TABLE `yi_sheng` (
  ...
  CONSTRAINT `yi_sheng_ibfk_1` FOREIGN KEY (`yi_yuan_id`) REFERENCES `yi_yuan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `yi_yuan` (
  ...
  CONSTRAINT `yi_yuan_ibfk_1` FOREIGN KEY (`denglu_id`) REFERENCES `deng_lu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `yi_yuan` VALUES ('4', '0', '县三院', '1301210000', '河北省', '石家庄市', '井陉县', '18131372240', '14', '61');
...
CREATE TABLE `zhen_liao_fang_an` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `isdelete` tinyint(1) NOT NULL DEFAULT '0',
  `xingShenZhenDuan` varchar(255) DEFAULT NULL,
  `riQi` datetime NOT NULL,
  `yaoMing` varchar(255) DEFAULT NULL,
  `guiGe` varchar(255) DEFAULT NULL,
  `yongLiang` varchar(255) DEFAULT NULL,
  `yongFa` varchar(255) DEFAULT NULL,
  `ciShu` int(11) NOT NULL,
  `xinShenTiaoJie` varchar(255) DEFAULT NULL,
  `jianCeXiangMu` varchar(255) DEFAULT NULL,
  `xiLiCePing` varchar(255) DEFAULT NULL,
  `fuZhenShiJian` int(11) DEFAULT NULL,
  `ji_chu_xin_xi_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ji_chu_xin_xi_id` (`ji_chu_xin_xi_id`),
  CONSTRAINT `zhen_liao_fang_an_ibfk_1` FOREIGN KEY (`ji_chu_xin_xi_id`) REFERENCES `ji_chu_xin_xi` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
