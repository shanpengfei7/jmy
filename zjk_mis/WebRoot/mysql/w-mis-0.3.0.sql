...
CREATE TABLE `ji_chu_xin_xi` (
  ...
  jiuZhenYuanYin varchar(255),
	shuiMian varchar(255),
	shiYu int,
	chuXian1 varchar(255),
	chuXian2 varchaR(255),
	jiWangLeiSiFaZuo int,
	jiWangQuTiJiBing int,
	...
	geXingTeDian int,
	QingXuWenDingXing int,
	RenGeTeDian int,
	XueXing int,
	RenGeTeZhi varchar(255),
	XingQu varchar(255),
	yan int,
	jiu int,
	yanJiuQiTa int,
	shengZhangFaYu varchar(255),
	xueBu int,
	yuYan int,
	yueJingChuChao int,
	shouCiYiJing int,
	tingJing int,
	youNianFuYangRen varchar(255),
	jiYangShi1 int,
	jiYangShi2 int,
	youNianShengHuoHuanJing varchar(255),
	xianZaiShengHuoHuanJIng varchar(255),
	xiongDiJieMeiGuanXi int,
	fuQiGuanXi int,
	poXiGuanXi int,
	fuQinZhiYe varchar(255),
	muQinZhiYe varchar(255),
	fuQinWenHuaChengDu varchar(255),
	muQinWenHuaChengDu varchar(255),
	zhongDaFuXingShiJian1 int,
	zhongDaFuXingShiJian2 text,
	yingJiShiJian1 int,
	yingJiShiJian2 text,
	renJiGuanXi int,
	wenTiBiaoXianWei varchar(255),
	wenTiFaShengZai varchar(255),
	shengHuoManYiYuFou int,
	buManYiDeFangMian varchar(255),
	dangQianJiBingRenZhi int,
	jiBingYuHouTaiDu int,
	yingDuiFangShi int,
	zhiLiaoCanYuChengDu int,
	sheHuiZhiChi int,
	pengYou int,
	jiaRen int,
	duiGeXiangZhiChiLiYongDu int,
  PRIMARY KEY (`id`),
...
INSERT INTO `yi_yuan` VALUES ('4', '0', '县三院', '1301210000', '河北省', '石家庄市', '井陉县', '18131372240', '14', '51');
