...
<html>
  ...
  <body>
  <form class="layui-form layui-form-pane" action="admin/enterprise/add.jmy" method="post">
  <input type="hidden" name="id" value="${id }">
  <div class="layui-form-item">
    <label class="layui-form-label">识别号</label>
    <div class="layui-input-inline">
      <input name="idCode" value="${idCode }" lay-verify="required" placeholder="请输入纳税人识别号" autocomplete="off" class="layui-input" type="text">
    </div>
  </div>
  <div class="layui-form-item">
