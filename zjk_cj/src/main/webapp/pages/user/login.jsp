		...
		<div class="xyh-login-form">	
			...
			<table width="70%" align="center" border="0">
				<tr>
					...
					<td width="71%">
						<input type="text" name="idCode" placeholder="纳税人识别号" class="len220" value=""/>
					</td>
				</tr>
				<tr>
					<th align="right"></th>
...
<script type="text/javascript">
	$(function() {
		...
		$("#btn_submit").on("click", function() {
			...
			$.post("user/index/login.jmy", {idCode:idCode,password:password,verify:verify}, function(data) {
				if(data.status == 1) {
					window.location.href="user/index/frame.jmy";
				} else {
					alert(data.error);
